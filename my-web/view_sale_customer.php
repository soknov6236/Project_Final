...
// Fetch sale items with color and size
$items_query = "SELECT si.*, p.name as product_name, p.color, p.size 
                FROM sale_items si
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-end">
                            <a href="print_invoice.php?id=<?= $sale_id ?>" class="btn btn-secondary btn-sm">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <th colspan="6" class="text-end">Tax (10%):</th>
